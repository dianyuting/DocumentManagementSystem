            ...
            <el-form ref="formRef" :model="form" :rules="rules" label-width="80px">
                <el-form-item label="用户名" prop="userName">
                    <el-row style="width: 100%;">
                        ...
                        <el-col :span="6">
                            <el-button @click="randomUsername">生成随机用户名</el-button>
                        </el-col>
                    </el-row>
                </el-form-item>
                ...
                <el-form-item label="确定密码" prop="confirmPassword" :required="true">
...
<script>
import { uploadProfile, getRandomUsername, register } from '@/request/api'
export default {
    data() {
        var validatePass = (rule, value, callback) => {
            if (value === '') {
                ...
                if (this.form.confirmPassword !== '') {
                    this.$refs.formRef.validateField('confirmPassword', () => null)
                }
                callback()
            }
        }
        ...
        return {
            rules: {
                ...
                confirmPassword: [{ required: true, trigger: 'blur', message: "请输入确定密码" },{ validator: validatePass2, trigger: 'blur' }],
        ...
        async onSubmit() {
            ...
            await vm.$refs['formRef'].validate((valid) => {
                if (valid) {
                    ...
                    alert("信息输入错误，或信息输入不全")
                }
            })
        },
        async randomUsername() {
            await getRandomUsername().then(res => {
                if (res.flag == 'success') {
